...
class AppLoadingWidget2 extends StatefulWidget {
  const AppLoadingWidget2({Key? key, this.height, this.alignment})
      : super(key: key);
  final double? height;
  ...
  _AppLoadingWidget2State createState() => _AppLoadingWidget2State();
}

class _AppLoadingWidget2State extends State<AppLoadingWidget2>
